...
public class Day06ATest {
    ...
    private final SafeSolver solver = new Day06ASolver();

    @Test
    public void testExampleCase() {
        long result = solver.solve(EXAMPLE_INPUT);
        assertEquals("El gran total del ejemplo es incorrecto.", 4277556L, result);
    }
    ...
    public void testFullInput() {
        ...
        System.out.println(">>> Solución Día 6 Parte A: " + result);
    }
}
